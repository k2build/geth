...
import (
	...
	"github.com/k2build/geth/crypto/signify"
	"github.com/k2build/geth/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/k2build/geth/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/k2build/geth/internal/version.gitDate="+env.Date)
	}
	if env.Tag != "" {
		ld = append(ld, "-X", "github.com/k2build/geth/params.gitTag="+env.Tag)
	}
