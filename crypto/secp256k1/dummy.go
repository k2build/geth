...
import (
	_ "github.com/k2build/geth/crypto/secp256k1/libsecp256k1/include"
	_ "github.com/k2build/geth/crypto/secp256k1/libsecp256k1/src"
	_ "github.com/k2build/geth/crypto/secp256k1/libsecp256k1/src/modules/recovery"
)
